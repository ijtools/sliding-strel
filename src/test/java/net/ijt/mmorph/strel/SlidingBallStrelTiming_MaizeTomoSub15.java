 ...
 *
 */
public class SlidingBallStrelTiming_MaizeTomoSub15
{
    ...
    {
        String fileName = SlidingBallStrelTiming_MaizeTomoSub15.class.getResource("/images/wheatGrain_tomo_180a_sub15.tif").getFile();
        ...
        writer.writeTable(table, new File("timing_slidingBall3D_WheatGrainTomo.csv"));
