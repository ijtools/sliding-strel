...
public class NaiveBallStrel3DTest
{
    ...
    /**
     * Test method for {@link net.ijt.mmorph.strel.NaiveBallStrel3D#dilation(ij.ImageStack)}.
     */
    @Test
    public final void testDilation()
    {
        ...
        // create the strel
        Strel3D strel = new NaiveBallStrel3D(5.0);
    ...
    /**
     * Test method for {@link net.ijt.mmorph.strel.NaiveBallStrel3D#erosion(ij.ImageStack)}.
     */
    @Test
